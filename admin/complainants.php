						...
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
									<?php if($row['status'] == 1): ?>
										<button class="btn btn-primary btn-sm m-0 unverify_user" type="button" data-id="<?php echo $row['id'] ?>" >Unverify</button>
									<?php else: ?>
										<button  class="btn btn-primary btn-sm m-0 verify_user" type="button" data-id="<?php echo $row['id'] ?>" >Verify</button>
									<?php endif; ?>
										<button class="btn btn-success btn-sm m-0 view_complaints" type="button" data-id="<?php echo $row['id'] ?>"   data-name="<?php echo $row['name'] ?>">View Complaints</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
