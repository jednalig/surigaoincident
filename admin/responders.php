							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn-outline-primary edit_responder" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn-outline-danger delete_responder" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
