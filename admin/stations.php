							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-primary btn-sm m-0 edit_station" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
										<button class="btn btn-danger btn-sm m-0 delete_station" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
